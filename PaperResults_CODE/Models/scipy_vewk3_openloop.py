...
class VaryingElastance():
    def __init__(self):
        self.E_max = 1.5 #3.0 # Segers
        self.E_min = 0.03 #0.3 # Segers
        self.t_peak = 0.32 #0.4
        self.T = 60/73
        self.Z_ao = 0.033 #0.1 # Segers
        self.C_ao = 1.13 # Segers 
        self.R_sys = 1.11 # Segers
        self.R_mv = 0.006 # 0.006 # Fresiello, Paeme et al.
        ...
        self.age = 54 #yrs, Arbitrarily chosen
        self.wt = 82.1 #kg, Arbitrarily chosen
        self.ht = 181.6 #cm, Arbitrarily chosen
        self.sex = "M"
        
        self.P_sv = 6.0 # mmHg, Stergiopulos
        self.P_la = 6.0 # mmHg, Stergiopulos
    ...
    def rhs(self, t, u):
        ...
        Q_aosv = (P_ao - self.P_sv)/self.R_sys
        Q_lv_in = (self.P_la > P_lv)*(self.P_la - P_lv)/self.R_mv

        der_V_lv = Q_lv_in - Q_lvao
    ...
    def calc_all(self, t, u):
        ...
        Q_aosv = (P_ao-self.P_sv)/self.R_sys
        Q_lv_in = (self.P_la - P_lv)/self.R_mv * (self.P_la > P_lv)
...
def test():
    ...
    sol = solve_ivp(vewk3.rhs, (tmin, tmax), [100, 100], max_step=0.05, t_eval=t_eval_vals)
