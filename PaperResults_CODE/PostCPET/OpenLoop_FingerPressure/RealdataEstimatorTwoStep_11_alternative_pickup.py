...
# Placehoder parameters, mainly taken from Segers et al Hypertension 2000
...
if __name__ == "__main__":
    ...
    for idx, row in data_table.iterrows():
        ...
        # Run estimates
        multi_sample(active, x0_0,None,False,t_r,p_r,q_r,v_r,b_in,b_low,30,row['PatientId'],idx)
