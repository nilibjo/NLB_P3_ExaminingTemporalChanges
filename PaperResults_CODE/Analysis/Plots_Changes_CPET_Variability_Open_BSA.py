...
# LoadPost CPET Finger Pressure Data

df_meas_FP_CPET = pd.read_pickle('Outputs_CPET_measurements_FP_BSA_CPET.pkl')
df_mod_FP_CPET = pd.read_pickle('Outputs_CPET_models_FP_Open_BSA_CPET.pkl')
...
df_meanvals_CPET_signed.to_csv('CPETchanges/Means_mod_CPET_signed_OL.csv')
df_meanvals_CPET.to_csv('CPETchanges/Means_mod_CPET_OL.csv')
...
df_meanvals_CPET_signed.to_csv('CPETchanges/Means_meas_CPET_signed_OL.csv')
df_meanvals_CPET.to_csv('CPETchanges/Means_meas_CPET_OL.csv')
