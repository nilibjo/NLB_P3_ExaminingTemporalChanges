...
# 6, 6-12
print(df_meas_changes_tono["R_sys_612wk"])
...
mAll_Rsys_C = pgn.corr(np.append(np.append(df_meas_changes_tono["R_sys_6wk"], df_meas_changes_tono["R_sys_12wk"]), df_meas_changes_tono["R_sys_612wk"]), np.append(np.append(df_mod_changes_tono["R_sys_6wk"], df_mod_changes_tono["R_sys_12wk"]), df_mod_changes_tono["R_sys_612wk"]))
mAll_Cao_C = pgn.corr(np.append(np.append(df_meas_changes_tono["C_ao_6wk"], df_meas_changes_tono["C_ao_12wk"]), df_meas_changes_tono["C_ao_612wk"]), np.append(np.append(df_mod_changes_tono["C_ao_6wk"], df_mod_changes_tono["C_ao_12wk"]), df_mod_changes_tono["C_ao_612wk"]))
mAll_Emax_C = pgn.corr(np.append(np.append(df_meas_changes_tono["E_max_6wk"], df_meas_changes_tono["E_max_12wk"]), df_meas_changes_tono["E_max_612wk"]), np.append(np.append(df_mod_changes_tono["E_max_6wk"], df_mod_changes_tono["E_max_12wk"]), df_mod_changes_tono["E_max_612wk"]))

mAll_Rsys_D = pgn.corr(np.append(np.append(df_meas_changes_fp["R_sys_6wk"], df_meas_changes_fp["R_sys_12wk"]), df_meas_changes_fp["R_sys_612wk"]), np.append(np.append(df_mod_changes_fp["R_sys_6wk"], df_mod_changes_fp["R_sys_12wk"]), df_mod_changes_fp["R_sys_612wk"]))
mAll_Cao_D = pgn.corr(np.append(np.append(df_meas_changes_fp["C_ao_6wk"], df_meas_changes_fp["C_ao_12wk"]), df_meas_changes_fp["C_ao_612wk"]), np.append(np.append(df_mod_changes_fp["C_ao_6wk"], df_mod_changes_fp["C_ao_12wk"]), df_mod_changes_fp["C_ao_612wk"]))
mAll_Emax_D = pgn.corr(np.append(np.append(df_meas_changes_fp["E_max_6wk"], df_meas_changes_fp["E_max_12wk"]), df_meas_changes_fp["E_max_612wk"]), np.append(np.append(df_mod_changes_fp["E_max_6wk"], df_mod_changes_fp["E_max_12wk"]), df_mod_changes_fp["E_max_612wk"]))
...
df_out_weeks.to_csv('CorrelationChanges/TableChangesBothWFAllWeeks_OL_BSA.csv')
df_out_weeks.to_excel('CorrelationChanges/TableChangesBothWFAllWeeks_OL_BSA.xlsx')

df_out_modmeas.to_csv('CorrelationChanges/TableModMeasBothWFAllWeeks_OL_BSA.csv')
df_out_modmeas.to_excel('CorrelationChanges/TableModMeasBothWFAllWeeks_OL_BSA.xlsx')
...
df_max.to_csv('CorrelationChanges/TableMinMaxChangesBothWFAllWeeks_OL_BSA.csv')
df_max.to_excel('CorrelationChanges/TableMinMaxChangesBothWFAllWeeks_OL_BSA.xlsx')

df_max_6wk.to_csv('CorrelationChanges/TableMinMaxModMeasBothWF6Weeks_OL_BSA.csv')
df_max_6wk.to_excel('CorrelationChanges/TableMinMaxModMeasBothWF6Weeks_OL_BSA.xlsx')

df_max_12wk.to_csv('CorrelationChanges/TableMinMaxModMeasBothWF12Weeks_OL_BSA.csv')
df_max_12wk.to_excel('CorrelationChanges/TableMinMaxModMeasBothWF12Weeks_OL_BSA.xlsx')
