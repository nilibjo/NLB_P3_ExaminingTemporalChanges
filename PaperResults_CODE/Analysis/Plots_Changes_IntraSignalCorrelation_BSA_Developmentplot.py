...
df_meas_FP_CPET = pd.read_pickle('Outputs_CPET_measurements_FP_BSA.pkl')
df_mod_FP_CPET = pd.read_pickle('Outputs_CPET_models_FP_BSA.pkl')
...
plt.savefig("CorrelationChanges_Means/ModC_CHANGE_boxplots.pdf")
plt.show()
...
plt.savefig("CorrelationChanges_Means/ModD_CHANGE_boxplots.pdf")
plt.show()
