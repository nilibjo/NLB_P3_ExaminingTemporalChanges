# Figure regression variables - Closed-loop cardiovascular model parameter estimation results
import pandas as pd
import numpy as np
...
df_reg_longform3["height"] = np.append(np.append(df_reg['height'], df_reg['height']),
                                                 df_reg['height'])
df_reg_longform3["VO2"] = np.append(np.append(df_reg['VO2_A'],
                                    np.array([np.nan]*len(df_reg['VO2_A']))), df_reg['VO2_B'])
df_reg_longform3["delta_VO2"] = np.append(np.append(df_reg['delta_VO2'], df_reg['delta_VO2']),
                                                    df_reg['delta_VO2'])
df_reg_longform3["delta_BMI"] = np.append(np.append(df_reg['delta_BMI'], df_reg['delta_BMI']),
                                                    df_reg['delta_BMI'])
df_reg_longform3["delta_Psys"] = np.append(np.append(df_reg['delta_Psys'], df_reg['delta_Psys']),
                                                     df_reg['delta_Psys'])
...
df_reg_longform3["Day"] = np.append( np.append( ["Day1"]*len(df_reg["id"]),
                                                ["Day2"]*len(df_reg["id"]) ),
                                     ["Day3"]*len(df_reg["id"]) )
df_reg_longform3["Week"] = np.append( np.append( [0.0]*len(df_reg["id"]), [6.0]*len(df_reg["id"]) ),
                                      [12.0]*len(df_reg["id"]) )
...
df_reg_longform3["R1minRpop"] = np.append(np.append(df_reg['R1minRpop'], df_reg['R1minRpop']),
                                          df_reg['R1minRpop'])
df_reg_longform3["C1minCpop"] = np.append(np.append(df_reg['C1minCpop'], df_reg['C1minCpop']),
                                          df_reg['C1minCpop'])
df_reg_longform3["E1minEpop"] = np.append(np.append(df_reg['E1minEpop'], df_reg['E1minEpop']),
                                          df_reg['E1minEpop'])
df_reg_longform3["RpersRpop"] = np.append(np.append(df_reg['RpersRpop'], df_reg['RpersRpop']),
                                          df_reg['RpersRpop'])
df_reg_longform3["CpersCpop"] = np.append(np.append(df_reg['CpersCpop'], df_reg['CpersCpop']),
                                          df_reg['CpersCpop'])
df_reg_longform3["EpersEpop"] = np.append(np.append(df_reg['EpersEpop'], df_reg['EpersEpop']),
                                          df_reg['EpersEpop'])
