...
for idx, row in data_table.iterrows():
    ...
    if patient_id in compiled_participants:
        continue
    else:
        compiled_participants.append([patient_id])
    
    # Find file for the relevant measurement day and participant
    skipflag = False
    ...
    kolonner8 = ["E_max","C_ao","R_sys","V_tot","C_sv","t_peak","Z_ao","stddevsq"]
